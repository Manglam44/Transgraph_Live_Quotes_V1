...
from src.utils.commodity_contracts import load_commodity_futures
...
def build_row(spec, ticker, mode):
    ...
    return (
        ...
        getattr(ticker.contract, 'lastTradeDateOrContractMonth', None),
        None,
        None,
        ticker.contract.symbol,
...
CONFIG = StreamerConfig(
    ...
    flow='futures_all',
    description='Commodity futures all streamer',
    load_specs=lambda args: load_commodity_futures(args.expiry_month),
    build_row=build_row,
    needs_expiry=True,
)
