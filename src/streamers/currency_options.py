...
from src.utils.currency_contracts import load_currency_options
...
CONFIG = StreamerConfig(
    ...
    flow='options_all',
    description='Currency options all streamer',
    load_specs=lambda args: load_currency_options(args.expiry_month),
    build_row=build_row,
    needs_expiry=True,
)
