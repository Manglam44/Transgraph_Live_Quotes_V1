...
from src.utils.currency_contracts import load_currency_futures
...
def build_row(spec, ticker, mode):
    ...
    return (
        ...
        mode.upper(),
        'currency',
        spec.metadata.get('instrument_type', 'future'),
...
CONFIG = StreamerConfig(
    ...
    flow='futures_all',
    description='Currency futures all streamer',
    load_specs=lambda args: load_currency_futures(args.expiry_month),
    build_row=build_row,
    needs_expiry=True,
)
